...
export function aboutProduction(context = document) {
    const root = context.querySelector("[data-about-production]");
    ...
    // mobile-l: 1 → tablet-l: 2 → desktop: 3
    const swiper = new Swiper(slider, {
        ...
        breakpoints: {
            // mobile-xl и ниже (<750) — 1 слайд; от 750 — 3 слайда,
            // активный по центру и крупнее остальных (см. макет)
            750: {
                slidesPerView: 3,
                spaceBetween: 24,
                centeredSlides: true
